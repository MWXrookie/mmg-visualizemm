...
### 📚 获奖论文知识库 RAG（M6）
- **三源知识库**：方法库（42 种结构化方法）+ 知识卡片库（40 张概念）+ 获奖论文全文（**23 篇历年国赛优秀论文**）
- **语义向量检索**：通义 text-embedding-v3 将 1238 个知识块向量化，AI 回答前自动检索最相关片段注入上下文，**回答可注明论文来源**
